...
const LOCAL_URL = 'http://bone-health-bkp.local/'
...
gulp.task('translate', function () {
	return gulp
		...
		.pipe(
			plugin.wpPot({
				domain: 'bone-health.local',
				package: 'Bone Health Australia',
			})
		)
...
gulp.task('default', gulp.parallel('fonts', 'styles', 'scripts', 'images'))
